...
O https://console.netapp.com/automationHub["Hub de automação do NetApp Console"^] Está disponível através da interface web do Console. O hub de automação fornece acesso a soluções que podem ajudar na implantação e integração automatizadas de produtos NetApp . A documentação dessas soluções está organizada em diversas áreas de produto ou funcionais, conforme descrito abaixo.
