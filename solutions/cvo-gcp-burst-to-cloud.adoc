...
keywords: bluexp automation hub, netapp automation solutions, gcp, cloud volumes ontap, burst to cloud, netapp, console 
summary: Este artigo oferece suporte à solução NetApp Cloud Volumes ONTAP para Google Cloud Automation, disponível para clientes NetApp no ​​hub NetApp Console Automation. 
---
...
.Antes de começar
* Você precisa baixar o link:https://console.netapp.com/automationHub["Cloud Volumes ONTAP para Google Cloud - estourar para a nuvem"^] Solução de automação através da interface web do Console. A solução é empacotada como `cvo_gcp_flexcache.zip`.
